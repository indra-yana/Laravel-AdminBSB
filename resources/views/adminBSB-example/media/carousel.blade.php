                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="{{ asset('adminBSB-master/images/image-gallery/11.jpg') }}" />
                                </div>
                                <div class="item">
                                    <img src="{{ asset('adminBSB-master/images/image-gallery/12.jpg') }}" />
                                </div>
                                <div class="item">
                                    <img src="{{ asset('adminBSB-master/images/image-gallery/19.jpg') }}" />
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div id="carousel-example-generic_2" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="{{ asset('adminBSB-master/images/image-gallery/10.jpg') }}" />
