...
@section('styles')
  ...
  <!-- JQuery Nestable Css -->
  <link href="{{ asset('adminBSB-master/plugins/nestable/jquery-nestable.css') }}" rel="stylesheet" />
@endsection
...
@section('scripts')
  <!-- Jquery Nestable -->
  <script src="{{ asset('adminBSB-master/plugins/nestable/jquery.nestable.js') }}"></script>
