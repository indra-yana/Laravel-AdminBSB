...
@section('scripts')
    ...
    <!-- ChartJs -->
    <script src="{{ asset('adminBSB-master/plugins/chartjs/Chart.bundle.js') }}"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="{{ asset('adminBSB-master/plugins/flot-charts/jquery.flot.js') }}"></script>
    <script src="{{ asset('adminBSB-master/plugins/flot-charts/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('adminBSB-master/plugins/flot-charts/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('adminBSB-master/plugins/flot-charts/jquery.flot.categories.js') }}"></script>
    <script src="{{ asset('adminBSB-master/plugins/flot-charts/jquery.flot.time.js') }}"></script>
