...
<html>
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" href="{{ asset('adminBSB-master/favicon.ico') }}" type="image/x-icon">
    ...
    <body class="theme-red">
        ...
        <script src="{{ asset('adminBSB-master/plugins/jquery-slimscroll/jquery.slimscroll.js') }}"></script>

        <!-- Waves Effect Plugin Js -->
        <script src="{{ asset('adminBSB-master/plugins/node-waves/waves.js') }}"></script>

        <!-- Custom Js -->
        <script src="{{ asset('adminBSB-master/js/admin.js') }}"></script>
        ...
        <!-- Demo Js -->
        <script src="{{ asset('adminBSB-master/js/demo.js') }}"></script>   
